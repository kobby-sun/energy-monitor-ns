...
declare var NSMakeRange, NSMutableAttributedString, NSKernAttributeName, android, NSDictionary, NSForegroundColorAttributeName, NSAttributedString, UIView : any;
...
function disableForm() {
	...
	loader.show({message: 'Logging in...'});
}
function enableForm() {
